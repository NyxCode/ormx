...
/// Derives [Table](/ormx/trait.Table.html) and generates a struct for inserting rows and accessors
/// to certain fields.
///
/// # Example
/// ```rust,ignore  
...
///
/// # CRUD
/// See the documentation of [Table](/ormx/trait.Table.html)
///
/// # Insertable
...
/// The generated struct can be used by [Table::insert](/ormx/trait.Table.html) or
/// [Insert::insert](/ormx/trait.Insert.html).
///
/// # Accessors: Getters
...
/// Derives [Patch](/ormx/trait.Patch.html).

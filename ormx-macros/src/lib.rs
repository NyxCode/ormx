...
/// Derives [Table](ormx::Table) and generates a struct for inserting rows and accessors to certain
/// fields.
///
/// Please also take a look at the documentation of [Table](ormx::Table) for information on
/// what requirements a table has to fulfill.
///
/// # Example
/// ```rust,ignore  
/// #[derive(ormx::Table)]
...
///
/// # CRUD
/// See the documentation of [Table](ormx::Table)
///
/// # Insertable
...
/// The generated struct can be used by [Table::insert](ormx::Table::insert) or
/// [Insert::insert](ormx::Insert::insert).
///
/// # Accessors: Getters
...
///
/// # Custom types
/// When using custom types (which implement [Type](sqlx::Type)), the field has to annotated with
